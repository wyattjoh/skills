<!-- source: .claude/references/devenv-full.md lines 1099-1196 -->
...
If you [import another `devenv.nix` file](/composing-using-imports/), the outputs will be merged together, allowing you to compose a developer environment and outputs in one logical unit.
