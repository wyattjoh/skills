<!-- source: https://devenv.sh/git-hooks/
     ...
     llms-full.txt lines 4902-5025 -->

# Git Hooks

`devenv` has first-class integration for [pre-commit](https://pre-commit.com/) via [git-hooks.nix](https://github.com/cachix/git-hooks.nix). This integration *requires* to have the `git-hooks` input the `devenv.yaml` file, as in [the inputs page](/inputs/).
