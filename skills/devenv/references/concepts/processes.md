...
> Run and supervise your development stack with devenv's built-in native process manager.
...
See [Alternative process managers](/supported-process-managers/) for the tradeoffs and manager-specific options.
