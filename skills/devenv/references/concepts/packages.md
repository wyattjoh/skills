<!-- source: .claude/references/devenv-full.md lines 16350-16518 -->
...
The `mvs solve` command spells out the plan behind the answer from a terminal, and [the raw input](/inputs/) exposes it to Nix as data. See [the fewest nixpkgs](https://fzakaria.com/2026/08/17/nixpkgs-multiverse-the-fewest-nixpkgs) for how the plan is computed and why it is minimal.
