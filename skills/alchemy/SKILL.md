...
| `drift [file]`                                                      | re-observe the cloud and report (or `--repair`) drift             | `--repair`, `--yes`                                            |
...
| `logs [file]`                                                       | fetch past log entries, or stream live with `--tail`             | `--resource <ids>`, `--tail`/`-t`, `--limit`, `--since`       |
