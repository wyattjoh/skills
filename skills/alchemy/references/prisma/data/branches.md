<!-- source: https://alchemy.run/prisma/data/branches
     upstream: website/src/content/docs/prisma/data/branches.mdx
     alchemy 2.0.0-beta.75 @ 808ef69 -->

# Branches

> Prisma branches group databases under git-style names — preview branches per stage, default-branch promotion, and database attachment.
