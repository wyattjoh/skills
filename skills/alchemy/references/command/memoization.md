<!-- source: https://alchemy.run/command/memoization
     upstream: website/src/content/docs/command/memoization.mdx
     alchemy 2.0.0-beta.75 @ 808ef69 -->

# Memoization: builds & one-off commands

> Content-hash memoization shared by Command.Build and Command.Exec — what gets hashed, when a command re-runs, and the outdir contract on destroy.
