<!-- source: https://alchemy.run/command
     upstream: website/src/content/docs/command/index.mdx
     alchemy 2.0.0-beta.75 @ 808ef69 -->

# Command

> Alchemy's cloud-agnostic primitives for local processes in the deploy graph — memoized builds, one-off commands, and dev servers.
