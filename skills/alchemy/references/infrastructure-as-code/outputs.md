<!-- source: https://alchemy.run/infrastructure-as-code/outputs
     upstream: website/src/content/docs/infrastructure-as-code/outputs.mdx
     alchemy 2.0.0-beta.75 @ 808ef69 -->

# Inputs & Outputs

> Output<T> is alchemy's lazy reference type — the lazy values that flow between resources, get composed with .pipe, mapped, interpolated, and resolved during deploy.
