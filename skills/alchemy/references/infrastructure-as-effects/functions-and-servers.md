<!-- source: https://alchemy.run/infrastructure-as-effects/functions-and-servers
     upstream: website/src/content/docs/infrastructure-as-effects/functions-and-servers.mdx
     alchemy 2.0.0-beta.75 @ 808ef69 -->

# Functions & Servers

> Workers, Lambda Functions, and Containers ship runtime code along with their infrastructure — declared with the Effectful Constructor pattern, bind what you need, return what you expose.
