<!-- source: https://alchemy.run/planetscale/data/mysql
     upstream: website/src/content/docs/planetscale/data/mysql.mdx
     alchemy 2.0.0-beta.75 @ 808ef69 -->

# MySQL

> PlanetScale MySQL (Vitess) as Stack resources — databases, branches, and passwords, with SQL migrations per branch and a straight line into Cloudflare Hyperdrive.
