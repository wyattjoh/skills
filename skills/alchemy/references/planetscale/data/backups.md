<!-- source: https://alchemy.run/planetscale/data/backups
     upstream: website/src/content/docs/planetscale/data/backups.mdx
     alchemy 2.0.0-beta.75 @ 808ef69 -->

# Backups & restores

> Restore a PlanetScale backup into a fresh branch with backupId, or seed a new branch from the last successful backup with seedData.
