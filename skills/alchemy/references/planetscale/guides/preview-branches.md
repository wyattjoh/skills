<!-- source: https://alchemy.run/planetscale/guides/preview-branches
     upstream: website/src/content/docs/planetscale/guides/preview-branches.mdx
     alchemy 2.0.0-beta.75 @ 808ef69 -->

# Preview branches per PR

> Give every pull request its own PlanetScale branch — a long-lived database owned by a staging stage, referenced by ephemeral PR stages that fork, migrate, and tear down a branch each.
