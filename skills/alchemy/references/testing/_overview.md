<!-- source: https://alchemy.run/testing
     upstream: website/src/content/docs/testing/index.mdx
     alchemy 2.0.0-beta.77 @ c83b454 -->

# Testing

> How Alchemy tests work — real clouds by default, local emulators on demand, one Stack deploy per suite, isolated stages, deploy → assert → destroy.
