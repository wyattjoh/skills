<!-- source: https://alchemy.run/aws/apis/api-gateway
     upstream: website/src/content/docs/aws/apis/api-gateway.mdx
     alchemy 2.0.0-beta.75 @ 808ef69 -->

# REST API (API Gateway v1)

> Expose a Lambda with a regional Amazon API Gateway REST API using RestApi, Resource, Method, Deployment, and Stage primitives.
