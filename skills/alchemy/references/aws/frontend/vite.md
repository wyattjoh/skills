<!-- source: https://alchemy.run/aws/frontend/vite
     upstream: website/src/content/docs/aws/frontend/vite.mdx
     alchemy 2.0.0-beta.75 @ 808ef69 -->

# Vite

> Deploy a plain Vite app to AWS with AWS.Website.Vite — the vite build output on S3 behind CloudFront, SPA fallback at the edge, and Vite's own dev server under alchemy dev.
