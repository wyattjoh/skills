<!-- source: https://alchemy.run/aws/frontend/nextjs
     upstream: website/src/content/docs/aws/frontend/nextjs.mdx
     alchemy 2.0.0-beta.75 @ 808ef69 -->

# Next.js

> Deploy a Next.js app to AWS with AWS.Website.Nextjs — the OpenNext serverless topology with streaming SSR, image optimization, and ISR wiring, plus next dev under alchemy dev.
