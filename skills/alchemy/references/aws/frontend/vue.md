<!-- source: https://alchemy.run/aws/frontend/vue
     upstream: website/src/content/docs/aws/frontend/vue.mdx
     alchemy 2.0.0-beta.75 @ 808ef69 -->

# Vue

> Deploy a Vue single-page app to AWS with AWS.Website.Vite — S3 + CloudFront, deep links that work by default, and Vue's own Vite dev server under alchemy dev.
