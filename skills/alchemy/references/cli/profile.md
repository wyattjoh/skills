<!-- source: https://alchemy.run/cli/profile
     upstream: website/src/content/docs/cli/profile.mdx
     alchemy 2.0.0-beta.79 @ 0811092 -->

# profile

> Create, refresh, rename, edit, inspect, or delete Alchemy authentication profiles.
