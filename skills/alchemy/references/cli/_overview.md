<!-- source: https://alchemy.run/cli
     upstream: website/src/content/docs/cli/index.mdx
     alchemy 2.0.0-beta.75 @ 808ef69 -->

# CLI

> Every alchemy command at a glance — the command map, common options, and how the interactive TUI decides when to render.
