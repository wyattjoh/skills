<!-- source: https://alchemy.run/railway/frontend/vinext
     upstream: website/src/content/docs/railway/frontend/vinext.mdx
     alchemy 2.0.0-beta.79 @ 0811092 -->

# Vinext

> Deploy vinext to Railway with the shared Website API, native local development, and a platform-specific data cache.
