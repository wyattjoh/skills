<!-- source: https://alchemy.run/railway/frontend/solidstart
     upstream: website/src/content/docs/railway/frontend/solidstart.mdx
     alchemy 2.0.0-beta.75 @ 808ef69 -->

# SolidStart

> Deploy a SolidStart app to Railway with Railway.Website.SolidStart — nitro's node preset on a container Service, prerendered pages in the image, and SolidStart's own Vite dev server under alchemy dev.
