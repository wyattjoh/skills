<!-- source: https://alchemy.run/railway/frontend/nextjs
     upstream: website/src/content/docs/railway/frontend/nextjs.mdx
     alchemy 2.0.0-beta.75 @ 808ef69 -->

# Next.js

> Deploy a Next.js app to Railway with Railway.Website.Nextjs — next build plus a Node next({ dev: false }) container, and next dev under alchemy dev.
