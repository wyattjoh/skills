<!-- source: https://alchemy.run/railway/frontend/nuxt
     upstream: website/src/content/docs/railway/frontend/nuxt.mdx
     alchemy 2.0.0-beta.75 @ 808ef69 -->

# Nuxt

> Deploy a Nuxt app to Railway with Railway.Website.Nuxt — nitro's node preset on a Service, and Nuxt's own dev server under alchemy dev.
