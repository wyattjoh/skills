<!-- source: https://alchemy.run/railway/frontend/astro
     upstream: website/src/content/docs/railway/frontend/astro.mdx
     alchemy 2.0.0-beta.75 @ 808ef69 -->

# Astro

> Deploy an Astro app to Railway with Railway.Website.Astro — Node SSR on a Service container, static output as a file server, and Astro's own dev server under alchemy dev.
