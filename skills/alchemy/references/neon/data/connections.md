<!-- source: https://alchemy.run/neon/data/connections
     upstream: website/src/content/docs/neon/data/connections.mdx
     alchemy 2.0.0-beta.75 @ 808ef69 -->

# Connections

> Every Neon project and branch exposes direct and pooled connection URIs plus pre-parsed origin outputs — feed the direct origin to Hyperdrive and the pooled one to everything else.
