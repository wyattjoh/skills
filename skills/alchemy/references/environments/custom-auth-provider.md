<!-- source: https://alchemy.run/environments/custom-auth-provider
     upstream: website/src/content/docs/environments/custom-auth-provider.mdx
     alchemy 2.0.0-beta.75 @ 808ef69 -->

# Custom Auth Provider

> Plug a third-party API into alchemy login — a lazy credentials service backed by an AuthProvider that resolves keys from a Profile, env vars, or a refreshable session.
