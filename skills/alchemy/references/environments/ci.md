<!-- source: https://alchemy.run/environments/ci
     upstream: website/src/content/docs/environments/ci.mdx
     alchemy 2.0.0-beta.75 @ 808ef69 -->

# CI

> Set up CI/CD pipelines for alchemy projects with GitHub Actions, automated deployments, and PR previews — with provider credentials managed as code.
...
> Interactive `DeployWorkflow` widget; see the live page for its rendered output.
