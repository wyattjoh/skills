<!-- source: https://alchemy.run/environments/auth-providers
     upstream: website/src/content/docs/environments/auth-providers.mdx
     alchemy 2.0.0-beta.75 @ 808ef69 -->

# Auth Providers

> An Auth Provider produces the credentials for a cloud's API calls — resolved lazily as Effects, so tokens and role sessions can refresh instead of pinning one static key.
