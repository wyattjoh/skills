<!-- source: https://alchemy.run/fly/frontend/sveltekit
     upstream: website/src/content/docs/fly/frontend/sveltekit.mdx
     alchemy 2.0.0-beta.75 @ 808ef69 -->

# SvelteKit

> Deploy a SvelteKit app to Fly with Fly.Website.SvelteKit — kit SSR on a Machine, prerendered assets baked into the image, and Kit's own dev server under alchemy dev.
