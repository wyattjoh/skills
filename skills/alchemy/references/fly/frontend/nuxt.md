<!-- source: https://alchemy.run/fly/frontend/nuxt
     upstream: website/src/content/docs/fly/frontend/nuxt.mdx
     alchemy 2.0.0-beta.75 @ 808ef69 -->

# Nuxt

> Deploy a Nuxt app to Fly with Fly.Website.Nuxt — nitro's node preset on a Machine, assets baked into the image, and Nuxt's own dev server under alchemy dev.
