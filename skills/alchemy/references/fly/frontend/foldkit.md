<!-- source: https://alchemy.run/fly/frontend/foldkit
     upstream: website/src/content/docs/fly/frontend/foldkit.mdx
     alchemy 2.0.0-beta.75 @ 808ef69 -->

# Foldkit

> Deploy a Foldkit app to Fly with Fly.Website.Foldkit — a client-only Vite SPA on a Node static-file Service, fly.dev over shared IPv4, and Vite's own dev server under alchemy dev.
