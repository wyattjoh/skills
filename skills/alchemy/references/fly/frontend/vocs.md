<!-- source: https://alchemy.run/fly/frontend/vocs
     upstream: website/src/content/docs/fly/frontend/vocs.mdx
     alchemy 2.0.0-beta.75 @ 808ef69 -->

# Vocs

> Deploy a Vocs docs site to Fly with Fly.Website.Vocs — prerendered HTML on a Node static-file server, extensionless routes, and Vocs' own dev server under alchemy dev.
