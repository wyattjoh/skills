<!-- source: https://alchemy.run/fly/frontend/nextjs
     upstream: website/src/content/docs/fly/frontend/nextjs.mdx
     alchemy 2.0.0-beta.75 @ 808ef69 -->

# Next.js

> Deploy a Next.js app to Fly with Fly.Website.Nextjs — next build plus a Node next({ dev: false }) Machine, and next dev under alchemy dev.
