<!-- source: https://alchemy.run/fly/frontend/static-site
     upstream: website/src/content/docs/fly/frontend/static-site.mdx
     alchemy 2.0.0-beta.75 @ 808ef69 -->

# Static sites

> Deploy a static site to Fly with Fly.Website.StaticSite — a build command, a Node static-file server on a Machine, and https://{app}.fly.dev (or your hostname) on deploy.
