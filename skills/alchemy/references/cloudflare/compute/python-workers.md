<!-- source: https://alchemy.run/cloudflare/compute/python-workers
     upstream: website/src/content/docs/cloudflare/compute/python-workers.mdx
     alchemy 2.0.0-beta.75 @ 808ef69 -->

# Python Workers

> Deploy Cloudflare Python Workers by pointing main at a .py file — alchemy uploads the modules, vendors pyproject.toml dependencies with uv, and serves them locally through workerd's built-in Pyodide.
