<!-- source: https://alchemy.run/cloudflare/compute/previews
     upstream: website/src/content/docs/cloudflare/compute/previews.mdx
     alchemy 2.0.0-beta.79 @ 258f63b -->

# Worker Previews

> Deploy a branch or pull request as a first-class Preview of another Worker — its own URL, bindings, and isolated Durable Object state, without touching production traffic.
