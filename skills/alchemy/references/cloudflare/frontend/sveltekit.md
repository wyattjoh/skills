<!-- source: https://alchemy.run/cloudflare/frontend/sveltekit
     upstream: website/src/content/docs/cloudflare/frontend/sveltekit.mdx
     alchemy 2.0.0-beta.75 @ 808ef69 -->

# SvelteKit

> Deploy a SvelteKit app to Cloudflare Workers with Cloudflare.Website.SvelteKit — a wrangler-free in-memory adapter, real bindings on platform.env, and full-HMR local dev.
