<!-- source: https://alchemy.run/cloudflare/frontend/waku
     upstream: website/src/content/docs/cloudflare/frontend/waku.mdx
     alchemy 2.0.0-beta.75 @ 808ef69 -->

# Waku

> Deploy a Waku app to Cloudflare Workers with Cloudflare.Website.Waku — RSC server in the Worker, SSG pages as static assets, and a custom-entry seam for Durable Objects.
