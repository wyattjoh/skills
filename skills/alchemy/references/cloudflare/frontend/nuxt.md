<!-- source: https://alchemy.run/cloudflare/frontend/nuxt
     upstream: website/src/content/docs/cloudflare/frontend/nuxt.mdx
     alchemy 2.0.0-beta.75 @ 808ef69 -->

# Nuxt

> Deploy a Nuxt app to Cloudflare Workers with Cloudflare.Website.Nuxt — nitro's cloudflare_module preset, native nuxt.config.ts loading, and wrangler-free local dev.
