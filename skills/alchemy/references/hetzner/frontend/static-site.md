<!-- source: https://alchemy.run/hetzner/frontend/static-site
     upstream: website/src/content/docs/hetzner/frontend/static-site.mdx
     alchemy 2.0.0-beta.75 @ 808ef69 -->

# Static sites

> Deploy a static site to Hetzner with Hetzner.Website.StaticSite — a build command, a systemd unit on a Server, and http://{ipv4}:3000 (or your hostname) on deploy.
