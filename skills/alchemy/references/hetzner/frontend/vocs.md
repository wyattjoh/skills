<!-- source: https://alchemy.run/hetzner/frontend/vocs
     upstream: website/src/content/docs/hetzner/frontend/vocs.mdx
     alchemy 2.0.0-beta.75 @ 808ef69 -->

# Vocs

> Deploy a Vocs docs site to Hetzner with Hetzner.Website.Vocs — prerendered HTML on a systemd unit, extensionless routes, and Vocs' own dev server under alchemy dev.
