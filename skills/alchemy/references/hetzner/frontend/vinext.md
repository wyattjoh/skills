<!-- source: https://alchemy.run/hetzner/frontend/vinext
     upstream: website/src/content/docs/hetzner/frontend/vinext.mdx
     alchemy 2.0.0-beta.79 @ 0811092 -->

# Vinext

> Deploy vinext to Hetzner with the shared Website API, native local development, and a platform-specific data cache.
