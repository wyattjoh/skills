<!-- source: https://alchemy.run/hetzner/frontend/foldkit
     upstream: website/src/content/docs/hetzner/frontend/foldkit.mdx
     alchemy 2.0.0-beta.75 @ 808ef69 -->

# Foldkit

> Deploy a Foldkit app to Hetzner with Hetzner.Website.Foldkit — a client-only Vite SPA as a systemd unit on a Cloud Server, and Vite's own dev server under alchemy dev.
