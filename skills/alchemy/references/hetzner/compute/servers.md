<!-- source: https://alchemy.run/hetzner/compute/servers
     upstream: website/src/content/docs/hetzner/compute/servers.mdx
     alchemy 2.0.0-beta.75 @ 808ef69 -->

# Servers

> Launch Hetzner Cloud Servers with Alchemy — SSH keys and typed SSH access, cloud-init, networks, volumes, snapshots, and placement groups.
