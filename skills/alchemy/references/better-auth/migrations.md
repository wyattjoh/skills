<!-- source: https://alchemy.run/better-auth/migrations
     upstream: website/src/content/docs/better-auth/migrations.mdx
     alchemy 2.0.0-beta.75 @ 808ef69 -->

# Migrations

> Better Auth's schema is applied automatically at deploy by an internal alchemy Action — input-hash diffed, dead-code-eliminated from runtime bundles, opt-out with migrate false.
