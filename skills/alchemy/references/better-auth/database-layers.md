<!-- source: https://alchemy.run/better-auth/database-layers
     upstream: website/src/content/docs/better-auth/database-layers.mdx
     alchemy 2.0.0-beta.75 @ 808ef69 -->

# Database layers

> One Layer per environment → database pair — HTTP and serverless drivers where they exist, TCP drivers as the fallback, all routed through alchemy's binding system.
