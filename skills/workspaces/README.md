...
| `task`    | Create, update, redesign, execute, or drop work | Manages a task's whole lifecycle: registers work in the hub, binds branches and stacks by naming, and coordinates execution in member repos.                                                                 |
...
├── plan/                 # phases.md, tasks.md, and work plans
