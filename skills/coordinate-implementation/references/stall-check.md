...
> in the RESUME.md table at .scratch/<slug>/RESUME.md: read
...
> looping, apply the model fallback rule from the coordinate-implementation
> skill. Confirm the background monitor is still armed on the current pane id
> and re-arm with
