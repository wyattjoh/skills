...
Lefthook's handling of unstaged hunks and `stage_fixed` is covered under "Shared
semantics" in `SKILL.md`. Keep both tools read-only regardless: it is faster (no
